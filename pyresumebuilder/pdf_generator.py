...
def generate_resume(data):
    ...
    icons_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'assets', 'icons'))
    ...
    contact_data = [
        generate_contact_row(email_icon, data['contact'].get('email')),
        generate_contact_row(linkedin_icon, data['contact'].get('linkedin'), data['contact'].get('linkedin')),
        generate_contact_row(location_icon, data['contact'].get('location')),
        generate_contact_row(github_icon, data['contact'].get('github'), data['contact'].get('github')),
        generate_contact_row(phone_icon, data['contact'].get('phone')),
        generate_contact_row(website_icon, data['contact'].get('website'), data['contact'].get('website')),
    ]
